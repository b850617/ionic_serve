(function() {
	...
	angular
		...
		.controller('CanvasPointController', CanvasPointController);

	CanvasPointController.$inject = ['$scope', '$rootScope', 'canvasPointService'];

	/* @ngInject */
	function CanvasPointController($scope, $rootScope, canvasPointService) {
		...
		function initPaper() {
			...
			paper.setup('canvasPoint');
			var textItem = new PointText({
				content: 'Click and drag to select with point.',
